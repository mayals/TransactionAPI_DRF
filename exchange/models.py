...
class Transaction(models.Model):
    category = models.ForiengKey(Category,on_delete= models.SET_NULL,null=True,blank=False)
    currency =  models.ForeignKey(Currency,on_delete= models.PROTECT,null=True,blank=False)
    date_created =  models.DateTimeField(auto_now_add= True,auto_now=False)
    amount = models.DcimalField(max_digits=15,decimal_places=2,null=True,blank=False)
